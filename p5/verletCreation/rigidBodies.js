class Physics {
    ...
    detectCollision(body1, body2) {
        ...
        if(body2.minBB.x > body.maxBB.x || body2.maxBB.x < body1.minBB.x || body2.minBB.y > body1.maxBB.y || body2.maxBB.y < body1.minBB.y)
            return false;
        ...
        for(let i = 0; i < body1.constraintCount + body2.constraintCount; i++) {
            ...
            let dst = Physics.intervalDistance(body1.min, body1.max, body2.min, body2.max);
            ...
            if ( dst > 0)
                ...
                this.normal = axis;
                this.constraint = c;
                this.body = i < body1.constrain ? body1 : body2;
            }
